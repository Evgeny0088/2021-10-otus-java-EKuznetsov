...
// Добавил обновление клиента и список всех клиентов из базы
...
// Добавил обновление manager и список всех managers из базы
        managerSecondSelected.setLabel("ManagerSecondUpdated");
        dbServiceManager.saveManager(managerSecondSelected);
        var managerUpdated = dbServiceManager.getManager(managerSecondSelected.getNo())
                .orElseThrow(() -> new RuntimeException("Manager not found, id:" + clientSecondSelected.getId()));
