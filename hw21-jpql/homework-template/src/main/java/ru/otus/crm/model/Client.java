...
public class Client implements Cloneable {
    ...
    public Client(Long id, String name, Address address, Set<Phone> clientPhoneNumbers) {
        this.id = id;
        this.name = name;
        this.clientAddress = address;
        this.clientPhones = clientPhoneNumbers == null ? new HashSet<>() : clientPhoneNumbers;
